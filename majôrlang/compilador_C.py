...
"""
        ...
        del script
        self.variables = {}
        tipos_numerosint = ('INT8', 'INT16', 'INT32', 'INT64','BIN8','BIN16','BIN32','BIN64')
        self.main = open('main.c','w')
    ...
    def visit_array_assign(self,node):
        ...
        match tipo:
            case 'BIN8':
                print(self.interpret(node.position))
                return f"({node.nome} >> {self.interpret(node.position)}) & 1"
